...
export * from './types';
export declare class HUPActionError extends TypedError {
}
export declare class HUPActionHelper {
    private actionsConfig;
    constructor(actionsConfig?: ActionsConfig);
    /**
     ...
     */
    getHUPActionType(deviceType: string, currentVersion: string, targetVersion: string): ActionName;
    /**
     ...
     */
    isSupportedOsUpdate(deviceType: string, currentVersion: string, targetVersion: string): boolean;
}
