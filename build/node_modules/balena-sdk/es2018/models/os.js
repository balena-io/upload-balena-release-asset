...
const getOsModel = function (deps, opts) {
    ...
    const _getOsVersionsFromReleases = (releases, appTags) => {
        ...
        for (const release of releases) {
            ...
            results.push({
                ...
                line,
                strippedVersion,
                basedOnVersion: (_b = tagMap[BASED_ON_VERSION_TAG_NAME]) !== null && _b !== void 0 ? _b : strippedVersion,
            });
        }
        return results;
    };
     ...
     * });
     */
    const download = (0, util_1.onlyIf)(!isBrowser)(async function ({ deviceType, version = 'latest', ...restOptions }) {
        try {
