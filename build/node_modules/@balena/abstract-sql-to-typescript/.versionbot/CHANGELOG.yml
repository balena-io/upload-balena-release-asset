...
- commits:
    - subject: Allow for sbvr-types v7, v8, and v9
      hash: 574f9d591d56dfc31ae4f256e1e4708a5dd893cc
      body: ""
      footer:
        Change-type: patch
        change-type: patch
    ...
    - subject: Make @balena/sbvr-types a peer dependency
      hash: b8d463d58221dca32158405e7a64f73083e8d1be
      body: ""
      footer:
        Change-type: major
        change-type: major
...
- commits:
    - subject: Import the actual package.json rather than creating a built copy
      hash: 2b0a51ceb5ec16d80ea684da304e83667b89f0e7
      body: |
        This avoids messing up the paths and potentially using the wrong
        version
      footer:
        Change-type: patch
        change-type: patch
  ...
  version: 3.2.1
  title: ""
  date: 2024-06-17T16:10:13.778Z
- commits:
    - subject: Add a comment to generated types with the version that generated them
      hash: f90dff05efad572dc092b9c03632645eb38c4de4
      body: ""
      footer:
        Change-type: minor
        change-type: minor
      author: Pagan Gazzard
      nested: []
    - subject: Improve formatting of generated types
      hash: ed7a84e3432a59998195cdae773c9ce0fdc052e5
      body: ""
      footer:
        Change-type: patch
        change-type: patch
  ...
  version: 3.2.0
  title: ""
  date: 2024-06-17T15:03:28.712Z
- commits:
    - subject: Fix accidental duplicate properties when the verb contains a space
      hash: 6d343087a3a8333aa6ccbf40ea992c09a839cbf0
      body: ""
      footer:
        Change-type: patch
        change-type: patch
...
- commits:
    - subject: Use `[A] | []` rather than `[A?]` for singular references
      ...
      body: |
        This is a more accurate representation because the result will never
...
- commits:
    ...
    - subject: Use types directly from sbvr-types
      ...
      body: |
        This uses the typescript types exported from @balena/sbvr-types so that
        new types can be dynamically picked up and the types we expose will
        match those that sbvr-types expects, avoiding any potential issues if
        our hardcoded types were to diverge from the types sbvr-types actually
        expects
      footer:
        Change-type: major
        change-type: major
    ...
    - subject: Expose read vs write selection in generated types
      ...
      body: |
        This allows easily choosing read vs write types with just one set of
        types with no need to generate/manage two separate sets of typings. It
        also allows these typings to be passed as generics to other functions
...
- commits:
    - subject: Type JSON fields as object rather than {}
      hash: 113120528709cc6dc6b04da8e6c261747fd6858c
      body: ""
      footer:
        Change-type: patch
        change-type: patch
      ...
      author: Thodoris Greasidis
      nested: []
    - subject: Update @balena/lint to 7.0.0
      hash: 4214bf41def78ea576fb4007f26d08ca460704fe
      body: |
        Update @balena/lint from 6.2.2 to 7.0.0
      footer:
        Depends-on: https://github.com/balena-io-modules/node-balena-lint/pull/85
        depends-on: https://github.com/balena-io-modules/node-balena-lint/pull/85
        Change-type: patch
        change-type: patch
      author: Thodoris Greasidis
  ...
  version: 2.1.1
  title: ""
  date: 2023-08-22T13:58:29.351Z
- commits:
    - subject: Adds webresource typing generation
      hash: eb7e7c3a3eb1471f153c12c5bec6c06290ead596
      body: ""
      footer:
        Change-type: minor
        change-type: minor
