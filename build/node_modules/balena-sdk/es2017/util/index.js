...
class BalenaWebResourceFile extends Blob {
    constructor(blobParts, name, options) {
        var _a, _b;
        const opts = Object.assign(Object.assign({}, options), { type: (_b = (_a = options === null || options === void 0 ? void 0 : options.type) !== null && _a !== void 0 ? _a : mime.getType(name)) !== null && _b !== void 0 ? _b : undefined });
