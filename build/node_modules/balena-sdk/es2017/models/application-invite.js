...
const getApplicationInviteModel = function (deps, opts, getApplication) {
    ...
    const exports = {
        ...
        async getAllByApplication(slugOrUuidOrId, options = {}) {
            ...
            return await exports.getAll((0, util_1.mergePineOptions)({ $filter: { is_invited_to__application: id } }, options));
        },
        /**
         ...
         * });
         */
        async create(slugOrUuidOrId, { invitee, roleName, message }) {
            var _a;
            ...
            if (roles) {
                const roleId = (_a = roles[0]) === null || _a === void 0 ? void 0 : _a.id;
