...
const getDeviceModel = function (deps, opts) {
    ...
    const exports = {
        OverallStatus: device_overall_status_1.DeviceOverallStatus,
        /**
        ...
        history: {
             ...
             */
            async getAllByDevice(uuidOrId, { fromDate = (0, subDays_1.subDays)(new Date(), DEFAULT_DAYS_OF_REQUESTED_HISTORY), toDate, ...options } = {}) {
             ...
             *
             */
            async getAllByApplication(slugOrUuidOrId, { fromDate = (0, subDays_1.subDays)(new Date(), DEFAULT_DAYS_OF_REQUESTED_HISTORY), toDate, ...options } = {}) {
