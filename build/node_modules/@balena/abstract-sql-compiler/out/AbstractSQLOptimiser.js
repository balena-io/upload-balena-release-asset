...
const ConcatenateWithSeparator = (args) => {
...
const AddDateMatcher = tryMatches(matchArgs('AddDateDuration', DateValue, DurationValue), matchArgs('AddDateNumber', DateValue, NumericValue));
...
const typeRules = {
    ...
    AggregateJSON: matchArgs('AggregateJSON', Field),
    ...
    SubtractDateDuration: matchArgs('SubtractDateDuration', DateValue, DurationValue),
    ...
    StartsWith: matchArgs('StartsWith', TextValue, TextValue),
    Substring: (args) => {
    ...
    EscapeForLike: matchArgs('EscapeForLike', TextValue),
