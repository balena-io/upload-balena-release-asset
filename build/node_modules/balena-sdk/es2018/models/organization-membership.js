    ...
    const tagsModel = buildDependentResource({ pine }, {
        ...
        async getResourceId(membershipId) {
            if (typeof membershipId !== 'number') {
                throw new Error(`Unexpected type for membershipId provided in organization-membership tagsModel getResourceId: ${typeof membershipId}`);
            }
    ...
    const exports = {
        ...
        async getAllByOrganization(handleOrId, options = {}) {
            ...
            return await pine.get({
                resource: RESOURCE,
                options: (0, util_1.mergePineOptions)({ $filter: { is_member_of__organization: id } }, options),
            });
        },
        /**
