...
const getAuth = function (deps, opts) {
    ...
    const wrapAuthFn = (eventName, fn) => async function (...innerArgs) {
        try {
    ...
    const twoFactor = require('./2fa').default({
        ...deps,
        auth,
    }, opts);
    ...
    const memoizedActorWhoami = (0, memoizee_1.default)(actorWhoami, {
        primitive: true,
        promise: true,
    });
    ...
    async function getUserInfo() {
        ...
        if (actor.actorType !== 'user') {
            throw new Error('The authentication credentials in use are not of a user');
        }
        return {
