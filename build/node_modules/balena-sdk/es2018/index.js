...
tslib_1.__exportStar(require("./types/models"), exports);
tslib_1.__exportStar(require("./types/jwt"), exports);
tslib_1.__exportStar(require("./types/contract"), exports);
tslib_1.__exportStar(require("./types/user-invite"), exports);
...
const getSdk = function ($opts) {
     ...
     * @memberof balena
     */
    const settings = require('./util/settings-client').loadSettingsClient(opts);
    ...
    if (opts.requestLimit != null && opts.requestLimit > 0) {
        ...
        request.send = pThrottle({
            ...
            interval: (_a = opts.requestLimitInterval) !== null && _a !== void 0 ? _a : 60 * 1000,
            strict: true,
        })(request.send);
    }
    /* eslint-enable @typescript-eslint/no-require-imports */
    ...
    if (opts.retryRateLimitedRequests) {
        ...
        sdk.interceptors.push({
            async responseError(error) {
                var _a;
                if (!(error instanceof sdk.errors.BalenaRequestError) ||
                ...
                const retryAfterStr = (_a = error.responseHeaders) === null || _a === void 0 ? void 0 : _a.get('Retry-After');
                const retryAfter = retryAfterStr != null ? parseInt(retryAfterStr, 10) : undefined;
                if (retryAfter == null ||
...
const fromSharedOptions = function () {
    ...
    return (0, exports.getSdk)(sharedOpts);
};
