...
const getApiKeysModel = function ({ pine, request, 
...
sdkInstance, }, { apiUrl }) {
    const exports = {
         ...
         * });
         */
        async create({ name, expiryDate, description = null, }) {
            if (expiryDate === undefined) {
                throw new errors.BalenaInvalidParameterError('createApiKeyParams.expiryDate', expiryDate);
            }
            const apiKeyBody = {
                name,
                expiryDate,
         ...
         * });
         */
        async getAllNamedUserApiKeys(options = {}) {
         ...
         * });
         */
        async getProvisioningApiKeysByApplication(slugOrUuidOrId, options = {}) {
            const appOpts = {
                $select: 'actor',
            };
            const { actor } = (await sdkInstance.models.application.get(slugOrUuidOrId, appOpts));
            return await exports.getAll((0, util_1.mergePineOptions)({
                $filter: {
         ...
         * });
         */
        async getDeviceApiKeysByDevice(uuidOrId, options = {}) {
            const deviceOpts = {
                $select: 'actor',
            };
            const { actor } = (await sdkInstance.models.device.get(uuidOrId, deviceOpts));
            return await pine.get({
                resource: 'api_key',
                options: (0, util_1.mergePineOptions)({
                    $filter: {
